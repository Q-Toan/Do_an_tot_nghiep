    ...
    <>
      <section className="page-header">
        <div
          ...
          style={{
            backgroundImage: "url(/images/banner/banner5.png)",
          }}
        />
