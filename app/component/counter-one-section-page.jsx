  ...
  return (
    <section className="counter-one section-space flex justify-center items-center">
      <div
        ...
        data-jarallax=""
        data-speed="0.3"
        style={{ backgroundImage: 'url(/images/banner/banner1.png)', zIndex: 0 }}
      >
        <div id="jarallax-container-0" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', overflow: 'hidden', zIndex: -100 }}>
          <div
            style={{
              ...
              backgroundImage: 'url(https://template-intern.l5elb4sxvvqkvl.flashvps.xyz/Food/boskery/files//images/banner1.png)',
              position: 'fixed',
              top: 0,
              left: 0,
              width: '100%',
